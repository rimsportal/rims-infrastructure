...
# --- must match foundation/deployments/projects/Designstool/qa/backend.tf ---
$LOCATION        = "centralindia"
$STATE_RG        = "rg-rims-tfstate-qa"
$STATE_SA        = "rimstfstateqa"    # globally unique, 3-24 lowercase alphanumeric
